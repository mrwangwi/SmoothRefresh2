...
import com.lcodecore.reboundlayout.footer.BallPulseView;
import com.lcodecore.reboundlayout.header.GoogleDotView;
import com.lcodecore.reboundlayout.processor.AnimProcessor;
import com.lcodecore.reboundlayout.processor.IDecorator;
import com.lcodecore.reboundlayout.processor.OverScrollDecorator;
import com.lcodecore.reboundlayout.processor.RefreshProcessor;
import com.lcodecore.reboundlayout.utils.DensityUtil;
 ...
 */
public class ReboundLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
    ...
    public ReboundLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            mMaxHeadHeight = a.getDimensionPixelSize(R.styleable.TwinklingRefreshLayout_tr_max_head_height, (int) DensityUtil.dp2px(context, 240));
    ...
    private void detectGesture(MotionEvent ev, OnGestureListener listener) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if ((Math.abs(vy) > mMinimumFlingVelocity) || (Math.abs(vx) > mMinimumFlingVelocity)) {
    ...
    private boolean detectNestedScroll(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (index < 0) {
                    Log.e("TwinklingRefreshLayout", "Error processing scroll; pointer index for id " + mActivePointerId + " not found. Did any MotionEvents get skipped?");
                    return false;
                }
    ...
    public class CoContext {
        ...
        public void onRefresh() {
            pullListener.onRefresh(ReboundLayout.this);
        }

        public void onLoadMore() {
            pullListener.onLoadMore(ReboundLayout.this);
        }
        ...
        public boolean dispatchTouchEventSuper(MotionEvent ev) {
            return ReboundLayout.super.dispatchTouchEvent(ev);
        }
